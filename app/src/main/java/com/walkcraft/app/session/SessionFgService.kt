...
class SessionFgService : Service(), SensorEventListener {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        // Start Foreground (with type on Android 14+, else fallback)
        ...
        // Register step sensors (best effort; requires ACTIVITY_RECOGNITION at runtime on Android 10+)
        ...
        // 1-second ticker to update notification with hh:mm:ss + local step count
        scope.launch {
            while (isActive) {
